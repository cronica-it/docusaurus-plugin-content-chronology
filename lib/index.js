...
exports.eventDateComparator = exports.validateOptions = void 0;
...
async function pluginContentBlog(context, options) {
    ...
    const pluginDataDirRoot = path_1.default.join(generatedFilesDir, 'docusaurus-plugin-content-chronology');
    ...
    return {
        ...
        async loadContent() {
            ...
            const blogAuthorsListPath = (0, utils_1.normalizeUrl)([baseBlogUrl, authorsBasePath]);
        ...
        async contentLoaded({ content: blogContents, actions }) {
            ...
            const { blogSidebarTitle, blogPosts, blogListPaginated, blogTags, blogTagsListPath, blogAuthors, blogAuthorsListPath, } = blogContents;
            const listedBlogPosts = blogPosts.filter(blogUtils_1.shouldBeListed);
            ...
            if (Object.keys(blogAuthors).length > 0) {
                async function createAuthorsListPage() {
                    const authorsPropPath = await createData(`${(0, utils_1.docuHash)(`${blogAuthorsListPath}-authors`)}.json`, JSON.stringify((0, props_1.toAuthorsProp)({ blogAuthors }), null, 2));
                    addRoute({
                ...
                async function createAuthorPostsListPage(author) {
                    await Promise.all(author.pages.map(async (blogPaginated) => {
                        ...
                        const authorPropPath = await createData(`${(0, utils_1.docuHash)(metadata.permalink)}.json`, JSON.stringify((0, props_1.toAuthorProp)({ author, blogAuthorsListPath }), null, 2));
                ...
                await Promise.all(Object.values(blogAuthors).map(createAuthorPostsListPage));
            }
        },
...
var eventDateComparator_1 = require("./eventDateComparator");
Object.defineProperty(exports, "eventDateComparator", { enumerable: true, get: function () { return eventDateComparator_1.eventDateComparator; } });
